...
const ProblemSolutionSection = () => {
    return (
        <section className="py-12 relative overflow-hidden bg-[#0a0a0a] border-y border-white/5">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl h-[500px] bg-gradient-to-r from-red-500/5 to-indigo-500/5 blur-[120px] rounded-full pointer-events-none" />
