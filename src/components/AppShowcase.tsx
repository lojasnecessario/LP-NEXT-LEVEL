      ...
      <div className="relative flex flex-col justify-center items-center">
        ...
        <div className="space-y-8 mt-12 w-full">
          ...
          <div className="pt-8 border-t border-white/5">
            <button onClick={() => { trackMetaEvent('InitiateCheckout'); window.location.href = "/redirect"; }} className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl font-bold transition-all active:scale-95">
