        ...
        <section className="py-12 relative bg-[#050505] overflow-hidden border-y border-white/5">
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                <motion.div
                    ...
                    className="relative w-full aspect-[4/5] md:aspect-video bg-indigo-950/20 rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(99,102,241,0.1)] border border-indigo-500/20 mb-10 mx-auto max-w-3xl flex items-center justify-center"
                >
                    {/* Placeholder for GIF */}
                    <img 
                        src="/workout.gif" 
